...
# How to play
First - pick your version: i created two versions of Revival of Decked Out: **Tango version [download]** and **Avtem version [download]**.
...
3. **[optional]** Install mods above (or just download this mods folder and delete mods you don't need)
4. Unpack downloaded zip file in your saves folder
5. Enjoy!
